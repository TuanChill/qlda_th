<div class="dropdown">
    ...
    <ul class="dropdown-menu menu-cart dropdown-menu-end" aria-labelledby="cartDropdown" style="max-height: 300px; overflow-y: auto;">
                ...
                <a class="" href="#">
                    <div class="row d-flex align-items-center">
                        ...
                        <div class="col-6 col-md-7">
                            <a href="{{ route('productsClient.show', $item->product->id) }}"
                                class="text-decoration-none product-widget-name" style="color: black; font-weight: 600;">{{ $item->product->name }}</a>
                        ...
                        <div class="col-2 d-flex align-items-center">
                            <button type="button" class="btn btn-outline-danger btn-sm rounded-circle" onclick="removeItem({{ $item->id }})" style="color:#7A95A2; border-color: #7A95A2;">&times;</button>
                        </div>
                    </div>
                </a>
            </li>
        ...
        <div class="btn-group w-100">
            <a class="btn  btn-sm" href="{{ route('cart.index') }}" style="background-color: #5C636A; color: white; font-weight: 600;">Xem giỏ hàng</a>
            <a class="btn btn-sm" href="{{ route('checkout.index') }}" style="background-color: #7A95A2; color: white; font-weight: 600;">Thanh toán <i
