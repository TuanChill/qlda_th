<div class="dropdown">
    ...
    <ul class="dropdown-menu menu-cart dropdown-menu-end" aria-labelledby="favoriteDropdown" style="max-height: 300px; overflow-y: auto;">
                ...
                <a class="" href="#">
                    <div class="row d-flex">
                        ...
                        <div class="col-6 col-md-7">
                            <a href="{{ route('productsClient.show', $favorite->product->id) }}"
                                class="text-decoration-none  product-widget-name" style="color: #7A95A2;">{{ $favorite->product->name }}</a>
                        </div>
        ...
        <div class="btn-group w-100">
            <a class="btn  btn-sm" href="{{ route('favorites.index') }}"  style="background-color: #7a95a2; color: WHITE;font-weight: 600;">Xem danh sách yêu thích</a>
        </div>
