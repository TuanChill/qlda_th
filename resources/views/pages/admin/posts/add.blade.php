            ...
            <div class="col-12">
                <div class="card my-4">
                    <div class="card-header p-0 position-relative mt-n4 mx-3" style="background-color: #7A95A2;">
                        <div
                            class="shadow-danger border-radius-lg pt-4 pb-3 d-flex flex-column flex-md-row align-items-center justify-content-between">
                            <h5 class="text-white text-capitalize ps-3">Thêm Bài Viết</h5>
                            <a href="{{ route('post.index') }}">
                                <button type="button" style="background-color: white; color: #7A95A2;" class="btn btn-primary text-capitalize me-md-4 mb-2 mb-md-0">Danh sách</button>
                            </a>
                        </div>
                    </div>
