                            ...
                            <div class="card-header" style="background-color: #7A95A2;">
                                <div class="text-center">
                                    <h4 class="font-weight-bolder p-3 mb-0">
                                        <span class="text-white">BAE </span><span style="color: White;">BOUTIQUE</span>
                                    
                                    </h4>
                                    <span style="color: WHITE;">Nơi những thiên thần nhỏ bé bắt đầu <br>những cuộc hành trình</span>
                                </div>
                            </div>
                            <div class="card-body pb-0">                          
                                <form action="{{route('loginAdmin.store')}}" method="post">
                                    ...
                                    <div class="text-center mb-2">
                                        <button type="submit" name="submit" class="btn btn-primary w-50">Đăng nhập</button>
                                    </div>
                                </form>
                            </div>
                            <div class=" text-center  ">
                                ...
                                <p class="mb-3 text-sm mx-auto">
                                    ...
                                    <a href="{{route('registerAdmin')}}" class="text-link " style="color: #7A95A2; font-weight: 600;">Đăng ký ngay</a>
                                </p>
                            </div>
                        </div>
                    </div>
