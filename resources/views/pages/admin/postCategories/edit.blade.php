                    ...
                    <div class="card-header p-0 position-relative mt-n4 mx-3" style="background-color: #7A95A2;">
                        <div
                            ...
                            <a href="{{ route('postCategory.index') }}">
                                <button type="button" class="btn btn-primary text-capitalize me-4" style="background-color: white; color: #7A95A2;">Danh sách</button>
                            </a>
                        </div>
                    </div>
                            ...
                            <div class="col-6">
                                <div class="p-3">
                                    <form id="postCategoriesEditForm"
                                        action="{{ route('postCategory.update', $postCategory->id) }}" method="POST">
                                        @csrf
                                        @method('PUT')
                                        <div class="mb-3">
