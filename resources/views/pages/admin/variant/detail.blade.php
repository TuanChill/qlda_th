        ...
        <div class="col-12">
            <div class="card my-4">
                <div class="card-header p-0 position-relative mt-n4 mx-3 " style="background-color: #7A95A2;">
                    <div class="shadow-danger border-radius-lg pt-4 pb-3 d-flex align-items-center justify-content-between">
                        <h5 class="text-white text-capitalize ps-3">Chi tiết sản phẩm</h5>
                        <button style="background-color: white; color: #7A95A2;" type="button" class="btn btn-primary text-capitalize me-4" data-bs-toggle="modal" data-bs-target="#addProductVariationModal">
                            Thêm mới biến thể
                        </button>
                    </div>
                </div>
