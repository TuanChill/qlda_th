        ...
        <div class="col-12">
            <div class="card my-4">
                <div class="card-header p-0 position-relative mt-n4 mx-3" style="background-color: #7A95A2;">
                    <div class="shadow-danger border-radius-lg pt-4 pb-3 d-flex flex-column flex-md-row align-items-center justify-content-between">
                        ...
                        <div class="d-flex flex-column flex-md-row">
                            ...
                            <div class="d-flex flex-column flex-md-row">
                                <a href="{{ route('discounts.index') }}" class="btn btn-primary mb-2 mb-md-0 me-md-3" style="background-color: white; color: #7A95A2;" >Danh sách giảm giá</a>
                                <a href="{{ route('product.create') }}" class="btn btn-primary  mb-2 mb-md-0" style="background-color: white; color: #7A95A2;">Thêm mới</a>
                            </div>
                        </div>
                    </div>
                </div>
