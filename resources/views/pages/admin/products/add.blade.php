                    ...
                    <div class="card-header p-0 position-relative mt-n4 mx-3" style="background-color: #7A95A2;">
                        <div class="shadow-danger border-radius-lg pt-4 pb-3 d-flex flex-column flex-md-row align-items-center justify-content-between">
                            ...
                            <div class="d-flex flex-column flex-md-row">
                                <a href="{{ route('attributes.create') }}" class="btn btn-primary text-capitalize me-md-3 mb-2 mb-md-0" style="background-color: white; color: #7A95A2;">
                                    Thêm thuộc tính
                                </a>
                                <a href="{{ route('products.index') }}" class="btn btn-primary text-capitalize" style="background-color: white; color: #7A95A2;">
                                    Danh sách
                                </a>
                            </div>
                        </div>
