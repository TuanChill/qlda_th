            ...
            <div class="col-12">
                <div class="card my-4">
                    <div class="card-header p-0 position-relative mt-n4 mx-3 " style="background-color: #7A95A2;">
                        <div
                            ...
                            <a href="{{ route('banner.index') }}"><button type="button"
                                    class="btn btn-primary text-capitalize me-4" style="background-color: white; color: #7A95A2;">
                                    Danh sách
                                </button>
                            </a>
                        </div>
                    ...
                    <div class="card-body px-0 pb-2 mx-3">
                        <div class="row ">
                            <div class="col-6">
                                <img id="previewImage" class="w-100" src="{{ asset('images/' . $banner->image) }}"
                                    alt="Preview">

                            </div>
                            <div class="col-6">
                                <div class="p-3">
                                    <form id="bannerEditForm" action="{{ route('banner.update', $banner->id) }}"
                                        method="post" enctype="multipart/form-data">
                                        @csrf
                                        @method('PUT') <!-- Sử dụng phương thức PUT để cập nhật dữ liệu -->

                                        <!-- Các trường thông tin banner để chỉnh sửa -->
                                        <div class="mb-3">
                                        ...
                                        <!-- Các trường thông tin khác của banner để chỉnh sửa -->
                                        <div class="mb-3">
                                            ...
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" id="active" name="status"
                                                    value="1" {{ $banner->status == 1 ? 'checked' : '' }}>
